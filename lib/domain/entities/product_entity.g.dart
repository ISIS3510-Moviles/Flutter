...
ProductEntity _productEntityDeserialize(
  ...
  final object = ProductEntity(
    ...
    isAvailable: reader.readBool(offsets[2]),
...
extension ProductEntityQuerySortBy
  ...
  QueryBuilder<ProductEntity, ProductEntity, QAfterSortBy> sortByIsAvailable() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProductEntity, ProductEntity, QAfterSortBy> sortByPhoto() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'photo', Sort.asc);
    });
  }

  QueryBuilder<ProductEntity, ProductEntity, QAfterSortBy> sortByPhotoDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProductEntity, ProductEntity, QAfterSortBy> sortByRating() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'rating', Sort.asc);
    });
  }

  QueryBuilder<ProductEntity, ProductEntity, QAfterSortBy> sortByRatingDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ProductEntityQuerySortThenBy
  ...
  QueryBuilder<ProductEntity, ProductEntity, QAfterSortBy> thenByIsAvailable() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isAvailable', Sort.asc);
    });
  }
  ...
  QueryBuilder<ProductEntity, ProductEntity, QAfterSortBy> thenByPhoto() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'photo', Sort.asc);
    });
  }

  QueryBuilder<ProductEntity, ProductEntity, QAfterSortBy> thenByPhotoDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'photo', Sort.desc);
    });
  }
  ...
  QueryBuilder<ProductEntity, ProductEntity, QAfterSortBy> thenByRating() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'rating', Sort.asc);
    });
  }

  QueryBuilder<ProductEntity, ProductEntity, QAfterSortBy> thenByRatingDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'rating', Sort.desc);
    });
  }
...
extension ProductEntityQueryWhereDistinct
  ...
  QueryBuilder<ProductEntity, ProductEntity, QDistinct> distinctByPhoto(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProductEntity, ProductEntity, QDistinct> distinctByRating() {
    return QueryBuilder.apply(this, (query) {
...
extension ProductEntityQueryProperty
  ...
  QueryBuilder<ProductEntity, bool, QQueryOperations> isAvailableProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProductEntity, String?, QQueryOperations> photoProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProductEntity, double, QQueryOperations> ratingProperty() {
    return QueryBuilder.apply(this, (query) {
